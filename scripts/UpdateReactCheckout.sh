...
echo "\nDownloading file from URL:https://dhn-mobile.s3.amazonaws.com/ios/checkout/$NEW_IOS_RELEASE_VERSION/DhanyatraBitcodeX10.framework.zip"
wget https://dhn-mobile.s3.amazonaws.com/ios/checkout/"$NEW_IOS_RELEASE_VERSION"/DhanyatraBitcodeX10.framework.zip
unzip DhanyatraBitcodeX10.framework.zip
cp -R Dhanyatra.framework ./ios/
#cp -R Dhanyatra.framework ./example/ios/
...
rm -rf DhanyatraBitcode*.framework.zip Dhanyatra.framework/ __MACOSX/
